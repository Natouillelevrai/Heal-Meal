<header class="fixed top-5 left-1/2 transform -translate-x-1/2 w-full max-w-screen-xl px-5 z-50 h-12">
    <nav
        class="bg-[#B7E7EB] pl-3 px-2 h-14 flex justify-around items-center rounded-lg ring-3 ring-white shadow-md shadow-black nav-container transition-all duration-150">
        <a class="h-12" href="/">
